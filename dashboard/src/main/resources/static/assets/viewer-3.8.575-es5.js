...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.AnnotationEditorParams=void 0;var _pdfjsLib=__webpack_require__(4);class AnnotationEditorParams{constructor(options,eventBus){this.eventBus=eventBus;this.#bindListeners(options);}#bindListeners(_ref){let{editorFreeTextFontSize,editorFreeTextColor,editorInkColor,editorInkThickness,editorInkOpacity}=_ref;const dispatchEvent=(typeStr,value)=>{this.eventBus.dispatch("switchannotationeditorparams",{source:this,type:_pdfjsLib.AnnotationEditorParamsType[typeStr],value});};editorFreeTextFontSize.addEventListener("input",function(){dispatchEvent("FREETEXT_SIZE",this.valueAsNumber);});editorFreeTextColor.addEventListener("input",function(){dispatchEvent("FREETEXT_COLOR",this.value);});editorInkColor.addEventListener("input",function(){dispatchEvent("INK_COLOR",this.value);});editorInkThickness.addEventListener("input",function(){dispatchEvent("INK_THICKNESS",this.valueAsNumber);});editorInkOpacity.addEventListener("input",function(){dispatchEvent("INK_OPACITY",this.valueAsNumber);});this.eventBus._on("annotationeditorparamschanged",evt=>{for(const[type,value]of evt.details){switch(type){case _pdfjsLib.AnnotationEditorParamsType.FREETEXT_SIZE:editorFreeTextFontSize.value=value;break;case _pdfjsLib.AnnotationEditorParamsType.FREETEXT_COLOR:editorFreeTextColor.value=value;break;case _pdfjsLib.AnnotationEditorParamsType.INK_COLOR:editorInkColor.value=value;break;case _pdfjsLib.AnnotationEditorParamsType.INK_THICKNESS:editorInkThickness.value=value;break;case _pdfjsLib.AnnotationEditorParamsType.INK_OPACITY:editorInkOpacity.value=value;break;}}});}}exports.AnnotationEditorParams=AnnotationEditorParams;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.OverlayManager=void 0;class OverlayManager{#overlays=new WeakMap();#active=null;get active(){return this.#active;}async register(dialog){let canForceClose=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false;if(typeof dialog!=="object"){throw new Error("Not enough parameters.");}else if(this.#overlays.has(dialog)){throw new Error("The overlay is already registered.");}this.#overlays.set(dialog,{canForceClose});dialog.addEventListener("cancel",evt=>{this.#active=null;});}async open(dialog){if(!this.#overlays.has(dialog)){throw new Error("The overlay does not exist.");}else if(this.#active){if(this.#active===dialog){throw new Error("The overlay is already active.");}else if(this.#overlays.get(dialog).canForceClose){await this.close();}else{throw new Error("Another overlay is currently active.");}}this.#active=dialog;dialog.showModal();dialog.classList.remove("hidden");}async close(){let dialog=arguments.length>0&&arguments[0]!==undefined?arguments[0]:this.#active;if(!this.#overlays.has(dialog)){throw new Error("The overlay does not exist.");}else if(!this.#active){throw new Error("The overlay is currently not active.");}else if(this.#active!==dialog){throw new Error("Another overlay is currently active.");}dialog.close();this.#active=null;}}exports.OverlayManager=OverlayManager;
...
var InternalStateModule = __webpack_require__(97);
var defineProperty = (__webpack_require__(71).f);
var defineIterator = __webpack_require__(101);
var createIterResultObject = __webpack_require__(122);
...
var NATIVE_BIND = __webpack_require__(44);
...
var global = __webpack_require__(51);
var defineGlobalProperty = __webpack_require__(55);
...
var DESCRIPTORS = __webpack_require__(69);
var V8_PROTOTYPE_DEFINE_BUG = __webpack_require__(70);
...
var ordinaryToPrimitive = __webpack_require__(83);
var wellKnownSymbol = __webpack_require__(50);
var $TypeError = TypeError;
...
var isCallable = __webpack_require__(66);
var isPrototypeOf = __webpack_require__(79);
var USE_SYMBOL_AS_UID = __webpack_require__(62);
var $Object = Object;
...
var isCallable = __webpack_require__(66);
var tryToString = __webpack_require__(82);
var $TypeError = TypeError;
module.exports = function (argument) {
...
var lengthOfArrayLike = __webpack_require__(90);
...
var global = __webpack_require__(51);
var isObject = __webpack_require__(65);
var createNonEnumerableProperty = __webpack_require__(99);
var hasOwn = __webpack_require__(56);
...
var DESCRIPTORS = __webpack_require__(69);
var definePropertyModule = __webpack_require__(71);
var createPropertyDescriptor = __webpack_require__(100);
...
var call = __webpack_require__(76);
var IS_PURE = __webpack_require__(53);
var FunctionName = __webpack_require__(107);
var isCallable = __webpack_require__(66);
...
var createNonEnumerableProperty = __webpack_require__(99);
var defineBuiltIn = __webpack_require__(105);
var wellKnownSymbol = __webpack_require__(50);
var Iterators = __webpack_require__(96);
...
var isCallable = __webpack_require__(66);
var definePropertyModule = __webpack_require__(71);
var makeBuiltIn = __webpack_require__(106);
var defineGlobalProperty = __webpack_require__(55);
...
var hasOwn = __webpack_require__(56);
var DESCRIPTORS = __webpack_require__(69);
var CONFIGURABLE_FUNCTION_NAME = (__webpack_require__(107).CONFIGURABLE);
...
var getOwnPropertyDescriptorModule = __webpack_require__(103);
var definePropertyModule = __webpack_require__(71);
...
var uncurryThisAccessor = __webpack_require__(120);
var anObject = __webpack_require__(64);
...
var collectionStrong = __webpack_require__(147);
...
var iterate = __webpack_require__(137);
...
var isExtensible = __webpack_require__(134);
var uid = __webpack_require__(58);
var FREEZING = __webpack_require__(136);
var REQUIRED = false;
...
var isObject = __webpack_require__(65);
var classof = __webpack_require__(46);
var ARRAY_BUFFER_NON_EXTENSIBLE = __webpack_require__(135);
...
var getIteratorMethod = __webpack_require__(142);
...
var uncurryThis = __webpack_require__(139);
var aCallable = __webpack_require__(81);
var NATIVE_BIND = __webpack_require__(44);
...
var defineBuiltIns = __webpack_require__(149);
var bind = __webpack_require__(138);
var anInstance = __webpack_require__(144);
var isNullOrUndefined = __webpack_require__(48);
var iterate = __webpack_require__(137);
...
var uid = __webpack_require__(58);
var isCallable = __webpack_require__(66);
var isConstructor = __webpack_require__(154);
var isNullOrUndefined = __webpack_require__(48);
var isObject = __webpack_require__(65);
var isSymbol = __webpack_require__(77);
var iterate = __webpack_require__(137);
...
var getRegExpFlags = __webpack_require__(156);
var MapHelpers = __webpack_require__(158);
var SetHelpers = __webpack_require__(159);
var ERROR_STACK_INSTALLABLE = __webpack_require__(160);
var PROPER_TRANSFER = __webpack_require__(161);
...
var global = __webpack_require__(51);
var fails = __webpack_require__(45);
var V8 = __webpack_require__(60);
var IS_BROWSER = __webpack_require__(162);
var IS_DENO = __webpack_require__(163);
var IS_NODE = __webpack_require__(164);
